# Contribute to Web Components in Gutenberg
...
* [open an issue](https://github.com/felixarntz/web-components-in-gutenberg/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/felixarntz/web-components-in-gutenberg/compare) to the `master` branch
